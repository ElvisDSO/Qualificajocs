...
public class generador_pendientes {
	public static void main(String[] args) {

		FileWriter fichero = null;
		PrintWriter pw = null;
		final int NUM_JUEGOS_POR_JUGADOR = 10;
		final int NUM_JUGADORES_TOTALES = 500;

		try {

			fichero = new FileWriter("generador_pendientes.sql");
			pw = new PrintWriter(fichero);

			// final String[] rating = { "TODOS", "3", "7", "12", "16", "18" };

			pw.println("INSERT INTO `lista_pendientes` (`ID_VIDEOJUEGO`, `ID_USUARIO`) VALUES ");
			int contador = 1;
			int id_jugador = 1;
