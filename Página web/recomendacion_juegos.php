...
<head>
  ...
  <title>
    Qualificajocs - Recomendación Juegos.
  </title>
  ...
  <script src="js/recomendacion.js"></script>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="container-fluid" id="gridRecomendacion"></div>
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="container-fluid" id="gridTOP"></div>
              </div>
            </div>
          </div>
        </div>
...
/* Cambia el estado del puntero del ratón indicando al usuario que se presenta un botón "clickeable". */
  $(document).ready(function() {
    desplegarRecomendacion(<?php $criterioIdUsuario; ?>);
    desplegarTOP(<?php $criterioIdUsuario; ?>);
