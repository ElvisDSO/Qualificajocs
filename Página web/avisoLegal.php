      ...
      <div class="main-panel">
        ...
        <div style="margin-top: 70px; padding: 45px 15px 2px">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <h2><?php echo $arrayRecursosIdioma['AvisoLegal']; ?></h2>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies1"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies2"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies3"]; ?></p>
              </div>
              <div class="col-md-12">
                <h3><?php echo $arrayRecursosIdioma["cookies4"]; ?></h3>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies5"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies6"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies7"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies8"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies9"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies10"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies11"]; ?></p>
              </div>
              <div class="col-md-12">
                <p><?php echo $arrayRecursosIdioma["cookies12"]; ?></p><a href="http://blog.legisconsulting.com/2013/09/modelo-de-aviso-y-politica-de-cookies-segun-la-agpd/">http://blog.legisconsulting.com</a>
              </div>
            </div>
          </div>
        </div>
